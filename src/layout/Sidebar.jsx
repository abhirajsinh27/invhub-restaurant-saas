...
function Sidebar() {
  ...
  return (
    <div className="w-64 h-screen bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 p-5 flex flex-col border-r border-slate-200 dark:border-slate-800 transition-colors duration-300">
      {/* Logo & Brand Name */}
