...
<>
                {filteredProducts.map((product, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span className="inline-block px-2 py-0.5 bg-purple-50 dark:bg-purple-955/20 text-purple-700 dark:text-purple-400 border border-purple-100 dark:border-purple-900/30 text-xs font-semibold rounded-md select-none">
                        {product.category}
                      </span>
                    </td>
                    <td className="px-6 py-4 text-center">
                      <p className="font-semibold text-slate-900 dark:text-slate-100">{product.qty} {product.unit || "pcs"}</p>
                    </td>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex justify-center gap-1">
                          ...
                          <button
                            ...
                            className="p-1.5 hover:bg-red-50 dark:hover:bg-red-950/20 rounded-md transition text-slate-500 dark:text-slate-400 hover:text-red-600 dark:hover:text-red-400 cursor-pointer"
                            title="Delete item"
                          >
                            <Trash2 size={16} />
                          </button>
