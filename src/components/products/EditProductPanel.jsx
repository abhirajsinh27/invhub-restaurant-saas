...
function EditProductPanel({ editingId, editData, handleChange, handleSave, setEditingId }) {
  return (
     <div
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 sticky top-0">
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Update product details</p>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              value={editData.sku}
              disabled
              className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-lg text-sm text-slate-400 dark:text-slate-500 cursor-not-allowed"
            />
          </div>
        ...
        {/* Footer */}
        <div className="p-6 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/60 flex gap-3 sticky bottom-0 select-none">
          <button
            onClick={() => setEditingId(null)}
          ...
          <button
            onClick={handleSave}
            className="flex-1 px-4 py-2 bg-purple-650 hover:bg-purple-700 text-white text-sm font-semibold rounded-lg transition cursor-pointer"
          >
            Save
          </button>
        </div>
